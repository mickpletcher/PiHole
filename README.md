...
|---------------|-----------------|
| `Lists/` | A collection of 57 blocklist sources, import scripts, and setup instructions |
...
| `Lists/Build-CuratedBlocklist.ps1` | A PowerShell script that builds curated blocklist and whitelist outputs locally. Generated files are not tracked in git — run this script to produce them. |
