...
| `Blocklists/Build-CuratedBlocklist.ps1` | A PowerShell script that builds a deduplicated domain blocklist from all source URLs and can optionally commit and push updates |
| `Blocklists/CuratedBlocklist.txt` | Generated deduplicated domain list created by Build-CuratedBlocklist.ps1 |
| `Blocklists/FailedSources.txt` | Run log file generated by Build-CuratedBlocklist.ps1 listing source URLs that failed download or parse (can be blank) |
